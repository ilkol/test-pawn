...
## 1.3.0
- Изменён подход к прочтению директив препроцессора
- Изменена грамматика, отвечающая за правила применения операторов и правил вырожений (expressions)
- Исправлено большое число ошибок в грамматике языка
- Исправлена подсветка после пустого многострочного коменатрия (/**/). Ранее расширение помечало все ниже как документацию
