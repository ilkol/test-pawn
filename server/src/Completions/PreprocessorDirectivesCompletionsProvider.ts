	...
	async getCompletions(lineTillCursor: string, params: TextDocumentPositionParams, document: AbstractOpenFile): Promise<CompletionItem[]> {
		...
		if (/^\s*#\s*\w*$/.test(lineTillCursor)) {
			return [
				...
				{ label: 'define', kind: CompletionItemKind.Keyword, sortText: "001", detail: Locale.t("Define some pattern to replace in code") },
				{ label: 'else', kind: CompletionItemKind.Keyword, sortText: "006" },
				{ label: 'elseif', kind: CompletionItemKind.Keyword, sortText: "007" },
				{ label: 'emit', kind: CompletionItemKind.Keyword },
				{ label: 'endif', kind: CompletionItemKind.Keyword, sortText: "005" },
				{ label: 'endinput', kind: CompletionItemKind.Keyword },
				{ label: 'endscript', kind: CompletionItemKind.Keyword },
				{ label: 'error', kind: CompletionItemKind.Keyword, sortText: "008" },
				{ label: 'file', kind: CompletionItemKind.Keyword },
				{ label: 'file', kind: CompletionItemKind.Keyword },
				{ label: 'if', kind: CompletionItemKind.Keyword, sortText: "004", detail: Locale.t("Preprocessing condition.") },
				{ label: 'include', kind: CompletionItemKind.Keyword, sortText: "002", detail: Locale.t("Includes file.") },
				{ label: 'line', kind: CompletionItemKind.Keyword},
				{ label: 'pragma', kind: CompletionItemKind.Keyword, sortText: "003", detail: Locale.t("Setting compiler.") },
				{ label: 'tryinclude', kind: CompletionItemKind.Keyword, sortText: "002"},
				{ label: 'undef', kind: CompletionItemKind.Keyword, sortText: "003"},
				{ label: 'warning', kind: CompletionItemKind.Keyword, sortText: "009"},
			];
		}
